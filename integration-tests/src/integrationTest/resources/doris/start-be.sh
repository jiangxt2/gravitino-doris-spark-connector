...
# Keep a 256 MiB safety floor so transient host pressure does not cancel metadata-only test queries.
echo "max_sys_mem_available_low_water_mark_bytes = 268435456" >> ${DORIS_BE_HOME}/conf/be.conf
